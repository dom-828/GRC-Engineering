...
# description: "Buckets must not allow public access. Firewalls must not expose management ports (22, 3389) to 0.0.0.0/0."
# custom:
#   control_id: AC-3
#   framework: nist-800-53
#   severity: high
#   remediation: "Set uniform_bucket_level_access=true and public_access_prevention=enforced on buckets. Narrow firewall source_ranges away from 0.0.0.0/0 for management ports."
...
some r in bucket_resource
not bucket_locked_down(r)
msg := sprintf(
